...
| 15.4         | `string`      | unknown                            |                                   | [CAL]: from a specific range or else fail | True
...
| 19           | `string`      | PskCalHash                         |                                   | [CAL]: get_psk_cal_hash(query_param, x_ss_stub) | Depends - required if login
...
| 25           | `string`      | optionType                         |                                   | [HINT]: situation type for deviceToken           | Depends - required if you don't want to send dyn
| 26           | `string`      | dynField                           |                                  
| 26.1         | `string`      | dynVersion                         |                                   | MssdkEP -> MsGetSeed                       | Depends - required if you sign dyn
| 26.2         | `string`      | dynHash                            |                                   | [CAL]: 8 different encryption types; encryptType encrypts query_param, x_ss_stub, XorRand >> 1 | Depends - required if you sign dyn for follow/like
| 27           | `string`      | Timestamp                          | timestamp << 1
| 28           | `string`      | OptionType                         |                                   | [HINT]: situation type for ie. deviceToken, seedData, 1002
| 29           | `string`      | Investigating                      |                                   | [UNKNOWN] 6 digit -> static 
| 30           | `bool`        | optionType                         |                                   | [HINT]: situation type checks for specific item in params
